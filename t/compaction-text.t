...
subtest "preprocess", sub {
  ...
  test_preprocess('Mixed Case 2', 'Hello WWorld', [ ['al','H'], ['ll','ello '], ['as','W'],['as','W'],['ll','orld'] ], overhead => 5); # really 4
  test_preprocess('Mixed Case 3', 'Hello WWWorld', [ ['al','H'], ['ll','ello '], ['as','W'],['as','W'],['as','W'],['ll','orld'] ], overhead => 6); # really 5
  test_preprocess('Mixed Case 4', 'Hello WWWWorld', [ ['al','H'], ['ll','ello '], ['al','WWWW'],['ll','orld'] ], overhead => 4); # really 4
};
